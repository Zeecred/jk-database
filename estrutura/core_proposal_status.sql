...
CREATE TABLE `proposal_status` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_PROPOSAL_STATUS_CODE` (`code`),
  KEY `IDX_PROPOSAL_STATUS_NAME` (`name`),
  KEY `IDX_PROPOSAL_STATUS_DELETED_AT` (`deleted_at`)
...
-- Dump completed on 2026-01-23 17:08:36
