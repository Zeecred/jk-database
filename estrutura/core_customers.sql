...
CREATE TABLE `customers` (
  ...
  KEY `IDX_CUSTOMER_SELLER` (`seller_id`),
  KEY `IDX_CUSTOMER_PROMOTER` (`promoter_id`),
  KEY `IDX_CUSTOMERS_STATUS` (`status`),
  CONSTRAINT `FK_CUSTOMER_PERSON` FOREIGN KEY (`person_id`) REFERENCES `persons` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_CUSTOMER_PROMOTER` FOREIGN KEY (`promoter_id`) REFERENCES `promoters` (`id`) ON DELETE SET NULL,
  CONSTRAINT `FK_CUSTOMER_SELLER` FOREIGN KEY (`seller_id`) REFERENCES `sellers` (`id`) ON DELETE SET NULL
...
-- Dump completed on 2026-01-23 17:10:37
