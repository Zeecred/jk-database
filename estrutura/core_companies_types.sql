...
CREATE TABLE `companies_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_COMPANIES_TYPES_CODE` (`code`),
  KEY `IDX_COMPANIES_TYPES_CREATED_AT` (`created_at`),
  KEY `IDX_COMPANIES_TYPES_DELETED_AT` (`deleted_at`)
...
-- Dump completed on 2026-01-23 17:12:59
