...
CREATE TABLE `users_has_roles` (
  ...
  KEY `FK_USERS_HAS_ROLES_ID_IDX` (`role_id`),
  CONSTRAINT `FK_USERS_HAS_ROLES_ROLES` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2026-01-23 17:10:01
