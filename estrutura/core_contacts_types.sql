...
CREATE TABLE `contacts_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNQ_CONTACTS_TYPES_NAME` (`name`),
  KEY `IDX_CONTACTS_TYPES_CREATED_AT` (`created_at`),
  KEY `IDX_CONTACTS_TYPES_DELETED_AT` (`deleted_at`)
...
-- Dump completed on 2026-01-23 17:07:26
