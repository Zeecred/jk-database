...
CREATE TABLE `white_labels` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_WHITE_LABELS_STATUS` (`status`),
  KEY `FK_WHITE_LABELS_PERSONS` (`person_id`),
  CONSTRAINT `FK_WHITE_LABELS_PERSONS` FOREIGN KEY (`person_id`) REFERENCES `persons` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2026-01-23 17:11:53
